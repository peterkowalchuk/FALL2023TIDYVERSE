...
#### I'm going to add on to this example by creating a scenario in which we have more data on movie genres
```{r}

## Generating Sample Data for Movie Genres
movie_genres <- tibble(
  Film = c("12 Mighty Orphans", "A Journal for Jordan", "A Quiet Place Part II", "After We Fell"),
  LocationMade = c("USA", "USA", "USA", "Canada")
)

## Displaying Movie Genres Data
print(movie_genres)

## Inner Join with Movie Ratings
full_movie_ratings_with_genres <- inner_join(full_movie_ratings, movie_genres, by = "Film")

## Displaying Extended Result
cat("\nExtended Result with Genres:\n")
full_movie_ratings_with_genres

```

## Secoond conclusion

In this extension, we introduced a crucial element to our movie ratings dataset—the "LocationMade" column. This addition enriches our dataset by providing insights into the geographical origins of each film.
